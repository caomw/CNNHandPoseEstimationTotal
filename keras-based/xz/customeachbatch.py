...
class BallModel(Layer):
    ...
    def _elemdot(self,batch,a,b):
        c=theano.shared(np.zeros((batch,3,4),dtype='float32'))
        c=T.set_subtensor(c[0,:],T.dot(a[0,:],b[0,:]))
        c=T.set_subtensor(c[1,:],T.dot(a[1,:],b[1,:]))
        c=T.set_subtensor(c[2,:],T.dot(a[2,:],b[2,:]))
        c=T.set_subtensor(c[3,:],T.dot(a[3,:],b[3,:]))
        c=T.set_subtensor(c[4,:],T.dot(a[4,:],b[4,:]))
        c=T.set_subtensor(c[5,:],T.dot(a[5,:],b[5,:]))
        c=T.set_subtensor(c[6,:],T.dot(a[6,:],b[6,:]))
        c=T.set_subtensor(c[7,:],T.dot(a[7,:],b[7,:]))
        c=T.set_subtensor(c[8,:],T.dot(a[8,:],b[8,:]))
        c=T.set_subtensor(c[9,:],T.dot(a[9,:],b[9,:]))
        c=T.set_subtensor(c[10,:],T.dot(a[10,:],b[10,:]))
        c=T.set_subtensor(c[11,:],T.dot(a[11,:],b[11,:]))
        c=T.set_subtensor(c[12,:],T.dot(a[12,:],b[12,:]))
        c=T.set_subtensor(c[13,:],T.dot(a[13,:],b[13,:]))
        c=T.set_subtensor(c[14,:],T.dot(a[14,:],b[14,:]))
        c=T.set_subtensor(c[15,:],T.dot(a[15,:],b[15,:]))
        c=T.set_subtensor(c[16,:],T.dot(a[16,:],b[16,:]))
        c=T.set_subtensor(c[17,:],T.dot(a[17,:],b[17,:]))
        c=T.set_subtensor(c[18,:],T.dot(a[18,:],b[18,:]))
        c=T.set_subtensor(c[19,:],T.dot(a[19,:],b[19,:]))
        c=T.set_subtensor(c[20,:],T.dot(a[20,:],b[20,:]))
        c=T.set_subtensor(c[21,:],T.dot(a[21,:],b[21,:]))
        c=T.set_subtensor(c[22,:],T.dot(a[22,:],b[22,:]))
        c=T.set_subtensor(c[23,:],T.dot(a[23,:],b[23,:]))
        c=T.set_subtensor(c[24,:],T.dot(a[24,:],b[24,:]))
        c=T.set_subtensor(c[25,:],T.dot(a[25,:],b[25,:]))
        c=T.set_subtensor(c[26,:],T.dot(a[26,:],b[26,:]))
        c=T.set_subtensor(c[27,:],T.dot(a[27,:],b[27,:]))
        c=T.set_subtensor(c[28,:],T.dot(a[28,:],b[28,:]))
        c=T.set_subtensor(c[29,:],T.dot(a[29,:],b[29,:]))
        c=T.set_subtensor(c[30,:],T.dot(a[30,:],b[30,:]))
        c=T.set_subtensor(c[31,:],T.dot(a[31,:],b[31,:]))   
        return c
    ...
    def get_output(self, train=False):        
        ...
        ro=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._getrx(self.batchsize,d[:,3]),self._getry(self.batchsize,d[:,4])),self._getrz(self.batchsize,d[:,5]))
        ...
        xi1to16=self._elemdot(self.batchsize,ro,T.tile(np.array(initial[0:16]).T.reshape((1,3,16)),(self.batchsize,1,1)))+o1to16
        #print 'before:'
        #print self._elemdot(self.batchsize,ro,T.tile(np.array(initial[0:16]).T.reshape((1,3,16)),(self.batchsize,1,1))).eval()
        #print 'o1to16:'
        #print o1to16.eval()
        #print 'xi1to16:'
        #print xi1to16.eval()
        ####################################Thumb First
        ###17-20
        r16=self._elemdot(self.batchsize,self._getry(self.batchsize,d[:,6]),self._getrz(self.batchsize,d[:,7]))
        ...
        xi17to20=self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),T.tile(np.array(initial[16:20]).T.reshape((1,3,4)),(self.batchsize,1,1))-xori16)+o17to20
        ...
        xi21to22=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),r20), T.tile(np.array(initial[20:22]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori20)+o21to22
        ...
        xi23to24=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),r20),r22) ,T.tile(np.array(initial[22:24]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori22)+o23to24


        ######################################First Joint Index
        ###25-26
        r13=self._elemdot(self.batchsize,self._getrx(self.batchsize,d[:,10]),self._getry(self.batchsize,d[:,11]))
        ...
        xi25to26=self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r13),T.tile(np.array(initial[24:26]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori13)+o25to26


        ######################################First Joint Middle
        ###31-32
        r14=self._elemdot(self.batchsize,self._getrx(self.batchsize,d[:,14]),self._getry(self.batchsize,d[:,15]))
        ...
        xi31to32=self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r14),T.tile( np.array(initial[30:32]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori14)+o31to32


        ######################################First Joint Ring
        ###37-38
        r15=self._elemdot(self.batchsize,self._getrx(self.batchsize,d[:,18]),self._getry(self.batchsize,d[:,19]))
        ...
        xi37to38=self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r15),T.tile(np.array(initial[36:38]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori15)+o37to38


        ######################################First Joint Little
        ###43-44
        r16=self._elemdot(self.batchsize,self._getrx(self.batchsize,d[:,22]),self._getry(self.batchsize,d[:,23]))
        txori16=theano.shared(np.zeros((self.batchsize,3,1),dtype='float32'))
        ...
        xi43to44=self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),T.tile(np.array(initial[42:44]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori16)+o43to44
        ...
        xi27to28=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r13),r26),T.tile(np.array(initial[26:28]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori26)+o27to28
        ...
        xi33to34=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r14),r32),T.tile(np.array(initial[32:34]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori32)+o33to34
        ...
        xi39to40=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r15),r38),T.tile(np.array(initial[38:40]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori38)+o39to40
        ...
        xi45to46=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),r44), T.tile(np.array(initial[44:46]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori44)+o45to46
        ...
        xi29to30=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r13),r26),r28),T.tile(np.array(initial[28:30]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori28)+o29to30
        ...
        xi35to36=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r14),r32),r34),T.tile(np.array(initial[34:36]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori34)+o35to36
        ...
        xi41to42=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r15),r38),r40),T.tile(np.array(initial[40:42]).T.reshape((1,3,2)),(self.batchsize,1,1))-xori40)+o41to42
        ...
        xi47to48=self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,self._elemdot(self.batchsize,ro,r16),r44),r46),T.tile(np.array(initial[46:48]).T.reshape((1,3,2)),(self.batchsize,1,1)) -xori46)+o47to48
