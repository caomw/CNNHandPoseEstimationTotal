...
model.add_node(Flatten(),name='densein',inputs=['FL','FM','FS'],merge_mode='sum',concat_axis=1)
model.add_node(Dense(3872, 6776,init='uniform', activation = 'relu'), name = 'concat', input='densein' )
