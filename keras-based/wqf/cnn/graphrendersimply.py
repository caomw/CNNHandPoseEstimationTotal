...
model.add_node(Dense(9680,1024, init='uniform', activation = 'relu'), name = 'FL1', input='densein')
#model.add_node(Dense(1024,1024, init='uniform', activation = 'relu'), name = 'FL2', input='FL1')


model.add_node(Dense(1024,26, init='uniform'), name = 'dof', input = 'FL1')
...
print 'compile ok.'
x=np.zeros((640,1,96,96),dtype='float32')
xori=np.zeros((640,9216),dtype='float32')
limits=np.zeros((640,26),dtype='float32')
...
for epoch in range(0,1000):   
   ...
   for potionid in range(1,115):
      
      for i in range(0,640):
         x[i]=data96[ind[(potionid-1)*640+i]]
         xori[i]=data96ori[ind[(potionid-1)*640+i]]
