...
class GaussianModel(Layer):
    ...
    def get_output(self, train=False):
        ...
        ox1=self.middle[:,(0)*3].reshape((self.batchsize,1))
        x1=T.tile(ox1,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy1=self.middle[:,(0)*3+1].reshape((self.batchsize,1))
        ...
        ox2=self.middle[:,(1)*3].reshape((self.batchsize,1))
        x2=T.tile(ox2,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy2=self.middle[:,(1)*3+1].reshape((self.batchsize,1))
        ...
        ox3=self.middle[:,(2)*3].reshape((self.batchsize,1))
        x3=T.tile(ox3,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy3=self.middle[:,(2)*3+1].reshape((self.batchsize,1))
        ...
        ox4=self.middle[:,(3)*3].reshape((self.batchsize,1))
        x4=T.tile(ox4,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy4=self.middle[:,(3)*3+1].reshape((self.batchsize,1))
        ...
        ox5=self.middle[:,(4)*3].reshape((self.batchsize,1))
        x5=T.tile(ox5,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy5=self.middle[:,(4)*3+1].reshape((self.batchsize,1))
        ...
        ox6=self.middle[:,(5)*3].reshape((self.batchsize,1))
        x6=T.tile(ox6,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy6=self.middle[:,(5)*3+1].reshape((self.batchsize,1))
        ...
        ox7=self.middle[:,(6)*3].reshape((self.batchsize,1))
        x7=T.tile(ox7,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy7=self.middle[:,(6)*3+1].reshape((self.batchsize,1))
        ...
        ox8=self.middle[:,(7)*3].reshape((self.batchsize,1))
        x8=T.tile(ox8,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy8=self.middle[:,(7)*3+1].reshape((self.batchsize,1))
        ...
        ox9=self.middle[:,(8)*3].reshape((self.batchsize,1))
        x9=T.tile(ox9,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy9=self.middle[:,(8)*3+1].reshape((self.batchsize,1))
        ...
        ox10=self.middle[:,(9)*3].reshape((self.batchsize,1))
        x10=T.tile(ox10,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy10=self.middle[:,(9)*3+1].reshape((self.batchsize,1))
        ...
        ox11=self.middle[:,(10)*3].reshape((self.batchsize,1))
        x11=T.tile(ox11,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy11=self.middle[:,(10)*3+1].reshape((self.batchsize,1))
        ...
        ox12=self.middle[:,(11)*3].reshape((self.batchsize,1))
        x12=T.tile(ox12,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy12=self.middle[:,(11)*3+1].reshape((self.batchsize,1))
        ...
        ox13=self.middle[:,(12)*3].reshape((self.batchsize,1))
        x13=T.tile(ox13,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy13=self.middle[:,(12)*3+1].reshape((self.batchsize,1))
        ...
        ox14=self.middle[:,(13)*3].reshape((self.batchsize,1))
        x14=T.tile(ox14,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy14=self.middle[:,(13)*3+1].reshape((self.batchsize,1))
        ...
        ox15=self.middle[:,(14)*3].reshape((self.batchsize,1))
        x15=T.tile(ox15,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy15=self.middle[:,(14)*3+1].reshape((self.batchsize,1))
        ...
        ox16=self.middle[:,(15)*3].reshape((self.batchsize,1))
        x16=T.tile(ox16,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy16=self.middle[:,(15)*3+1].reshape((self.batchsize,1))
        ...
        ox17=self.middle[:,(16)*3].reshape((self.batchsize,1))
        x17=T.tile(ox17,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy17=self.middle[:,(16)*3+1].reshape((self.batchsize,1))
        ...
        ox18=self.middle[:,(17)*3].reshape((self.batchsize,1))
        x18=T.tile(ox18,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy18=self.middle[:,(17)*3+1].reshape((self.batchsize,1))
        ...
        ox19=self.middle[:,(18)*3].reshape((self.batchsize,1))
        x19=T.tile(ox19,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy19=self.middle[:,(18)*3+1].reshape((self.batchsize,1))
        ...
        ox20=self.middle[:,(19)*3].reshape((self.batchsize,1))
        x20=T.tile(ox20,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy20=self.middle[:,(19)*3+1].reshape((self.batchsize,1))
        ...
        ox21=self.middle[:,(20)*3].reshape((self.batchsize,1))
        x21=T.tile(ox21,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy21=self.middle[:,(20)*3+1].reshape((self.batchsize,1))
        ...
        ox22=self.middle[:,(21)*3].reshape((self.batchsize,1))
        x22=T.tile(ox22,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy22=self.middle[:,(21)*3+1].reshape((self.batchsize,1))
        ...
        ox23=self.middle[:,(22)*3].reshape((self.batchsize,1))
        x23=T.tile(ox23,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy23=self.middle[:,(22)*3+1].reshape((self.batchsize,1))
        ...
        ox24=self.middle[:,(23)*3].reshape((self.batchsize,1))
        x24=T.tile(ox24,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy24=self.middle[:,(23)*3+1].reshape((self.batchsize,1))
        ...
        ox25=self.middle[:,(24)*3].reshape((self.batchsize,1))
        x25=T.tile(ox25,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy25=self.middle[:,(24)*3+1].reshape((self.batchsize,1))
        ...
        ox26=self.middle[:,(25)*3].reshape((self.batchsize,1))
        x26=T.tile(ox26,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy26=self.middle[:,(25)*3+1].reshape((self.batchsize,1))
        ...
        ox27=self.middle[:,(26)*3].reshape((self.batchsize,1))
        x27=T.tile(ox27,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy27=self.middle[:,(26)*3+1].reshape((self.batchsize,1))
        ...
        ox28=self.middle[:,(27)*3].reshape((self.batchsize,1))
        x28=T.tile(ox28,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy28=self.middle[:,(27)*3+1].reshape((self.batchsize,1))
        ...
        ox29=self.middle[:,(28)*3].reshape((self.batchsize,1))
        x29=T.tile(ox29,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy29=self.middle[:,(28)*3+1].reshape((self.batchsize,1))
        ...
        ox30=self.middle[:,(29)*3].reshape((self.batchsize,1))
        x30=T.tile(ox30,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy30=self.middle[:,(29)*3+1].reshape((self.batchsize,1))
        ...
        ox31=self.middle[:,(30)*3].reshape((self.batchsize,1))
        x31=T.tile(ox31,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy31=self.middle[:,(30)*3+1].reshape((self.batchsize,1))
        ...
        ox32=self.middle[:,(31)*3].reshape((self.batchsize,1))
        x32=T.tile(ox32,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy32=self.middle[:,(31)*3+1].reshape((self.batchsize,1))
        ...
        ox33=self.middle[:,(32)*3].reshape((self.batchsize,1))
        x33=T.tile(ox33,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy33=self.middle[:,(32)*3+1].reshape((self.batchsize,1))
        ...
        ox34=self.middle[:,(33)*3].reshape((self.batchsize,1))
        x34=T.tile(ox34,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy34=self.middle[:,(33)*3+1].reshape((self.batchsize,1))
        ...
        ox35=self.middle[:,(34)*3].reshape((self.batchsize,1))
        x35=T.tile(ox35,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy35=self.middle[:,(34)*3+1].reshape((self.batchsize,1))
        ...
        ox36=self.middle[:,(35)*3].reshape((self.batchsize,1))
        x36=T.tile(ox36,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy36=self.middle[:,(35)*3+1].reshape((self.batchsize,1))
        ...
        ox37=self.middle[:,(36)*3].reshape((self.batchsize,1))
        x37=T.tile(ox37,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy37=self.middle[:,(36)*3+1].reshape((self.batchsize,1))
        ...
        ox38=self.middle[:,(37)*3].reshape((self.batchsize,1))
        x38=T.tile(ox38,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy38=self.middle[:,(37)*3+1].reshape((self.batchsize,1))
        ...
        ox39=self.middle[:,(38)*3].reshape((self.batchsize,1))
        x39=T.tile(ox39,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy39=self.middle[:,(38)*3+1].reshape((self.batchsize,1))
        ...
        ox40=self.middle[:,(39)*3].reshape((self.batchsize,1))
        x40=T.tile(ox40,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy40=self.middle[:,(39)*3+1].reshape((self.batchsize,1))
        ...
        ox41=self.middle[:,(40)*3].reshape((self.batchsize,1))
        x41=T.tile(ox41,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy41=self.middle[:,(40)*3+1].reshape((self.batchsize,1))
        ...
        ox42=self.middle[:,(41)*3].reshape((self.batchsize,1))
        x42=T.tile(ox42,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy42=self.middle[:,(41)*3+1].reshape((self.batchsize,1))
        ...
        ox43=self.middle[:,(42)*3].reshape((self.batchsize,1))
        x43=T.tile(ox43,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy43=self.middle[:,(42)*3+1].reshape((self.batchsize,1))
        ...
        ox44=self.middle[:,(43)*3].reshape((self.batchsize,1))
        x44=T.tile(ox44,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy44=self.middle[:,(43)*3+1].reshape((self.batchsize,1))
        ...
        ox45=self.middle[:,(44)*3].reshape((self.batchsize,1))
        x45=T.tile(ox45,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy45=self.middle[:,(44)*3+1].reshape((self.batchsize,1))
        ...
        ox46=self.middle[:,(45)*3].reshape((self.batchsize,1))
        x46=T.tile(ox46,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy46=self.middle[:,(45)*3+1].reshape((self.batchsize,1))
        ...
        ox47=self.middle[:,(46)*3].reshape((self.batchsize,1))
        x47=T.tile(ox47,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy47=self.middle[:,(46)*3+1].reshape((self.batchsize,1))
        ...
        ox48=self.middle[:,(47)*3].reshape((self.batchsize,1))
        x48=T.tile(ox48,(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
        oy48=self.middle[:,(47)*3+1].reshape((self.batchsize,1))
