...
class GaussianModel(Layer):
    ...
    def get_output(self, train=False):                
        ...
        for i in range(0,60):
            ...
            multiply=T.tile((self.middle[:,(i)+120]-minz+0.1).reshape((self.batchsize,1)),(1,self.height*self.width)).reshape((self.batchsize,self.height,self.width))
...
class BallModel(Layer):
    ...
    def _loopoverallbatch(self,batch):
        ...
        for k in range(0,3):
            ...
            for i in range(44+5*k-1,44+5*k):
            ...
            for i in range(44+5*k,44+5*k+2):
