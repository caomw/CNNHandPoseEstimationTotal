...
d=theano.shared(np.zeros((26),dtype='float32'))
d=T.set_subtensor(d[0],10.0)
d=T.set_subtensor(d[1],-3.0)
d=T.set_subtensor(d[2],5.0)
d=T.set_subtensor(d[3],math.pi/4)
d=T.set_subtensor(d[4],math.pi/2)
d=T.set_subtensor(d[5],-math.pi/3)
d=T.set_subtensor(d[6],math.pi/6)
d=T.set_subtensor(d[7],-math.pi/5)
d=T.set_subtensor(d[8],math.pi/12) 
d=T.set_subtensor(d[9],math.pi/10)
d=T.set_subtensor(d[10],-math.pi/8)
d=T.set_subtensor(d[11],math.pi/7)
d=T.set_subtensor(d[12],-math.pi/6)
d=T.set_subtensor(d[13],math.pi/5)
d=T.set_subtensor(d[14],math.pi/9)
d=T.set_subtensor(d[15],math.pi/3)
d=T.set_subtensor(d[16],-math.pi/2)
d=T.set_subtensor(d[17],math.pi/4)
d=T.set_subtensor(d[18],math.pi/6)
d=T.set_subtensor(d[19],-math.pi/7)
d=T.set_subtensor(d[20],math.pi/8)
d=T.set_subtensor(d[21],math.pi/10)
d=T.set_subtensor(d[22],math.pi/3)
d=T.set_subtensor(d[23],-math.pi/5)
d=T.set_subtensor(d[24],-math.pi/7)
d=T.set_subtensor(d[25],math.pi/10)



ro=T.dot(T.dot(getrx(d[3]),getry(d[4])),getrz(d[5]))
...
######################################First Joint Index
###25-26
r13=T.dot(getrx(d[10]),getry(d[11]))
...
######################################First Joint Middle
###31-32
r14=T.dot(getrx(d[14]),getry(d[15]))
...
######################################First Joint Ring
###37-38
r15=T.dot(getrx(d[18]),getry(d[19]))
...
######################################First Joint Little
###43-44
r16=T.dot(getrx(d[22]),getry(d[23]))
txori16=theano.shared(np.zeros((3,1),dtype='float32'))
