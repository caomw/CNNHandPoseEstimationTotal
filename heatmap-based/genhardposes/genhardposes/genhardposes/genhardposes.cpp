...
#define depprefix "H:\\libmodel\\hardposes\\"
...
void init()
{
	...
	FILE *fseq = fopen("D:\\CNN\\genlibmodeltrainHDF5\\seqhard.txt", "r");
	for (int i = 0; i < 19251; i++) { fscanf(fseq, "%d", &seq[i]); } //id:1-19251
	fclose(fseq);
