...
int main()
{
	FILE *fori=fopen("D:\\CNN\\lstmheatmapjoint8\\lstmheatmapjoint8\\lstmheatmapjoint8\\oriout.txt","r");
	for (int i=0;i<N;i++)
	{
	...
	fclose(fori);
	FILE *flstm=fopen("D:\\CNN\\lstmheatmapjoint8\\lstmheatmapjoint8\\lstmheatmapjoint8\\lstmout.txt","r");
	...
	fclose(flstm);
	FILE *ftarget=fopen("D:\\CNN\\lstmheatmapjoint8\\lstmheatmapjoint8\\lstmheatmapjoint8\\targetout.txt","r");
	for (int i=0;i<N;i++) 
	{
