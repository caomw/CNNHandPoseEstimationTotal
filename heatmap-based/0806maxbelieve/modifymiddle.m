                ...
                for m=1:NUM
                    ...
                    if (peakx0(2,9+1,k)<peakx0(2,7+1,j) && peakx0(2,11+1,l)<peakx0(2,9+1,k) && peakx0(2,13+1,m)<peakx0(2,11+1,l)) || (peakx0(2,9+1,k)>peakx0(2,7+1,j) && peakx0(2,11+1,l)>peakx0(2,9+1,k) && peakx0(2,13+1,m)>peakx0(2,11+1,l)) 
                        for confidence=1:CONFIDENCE %90 85 80 75 70 65 60 55 50                            
                            if ((peakrsquare(2,7+1,j)>=1.00-0.05*confidence)+(peakrsquare(2,9+1,k)>=1.00-0.05*confidence)+(peakrsquare(2,11+1,l)>=1.00-0.05*confidence)+(peakrsquare(2,13+1,m)>=1.00-0.05*confidence)>=4)
                            
                               if closemiddleabs>=7.0 &&  farmiddleabs<=18.0 && farmiddle<24.0 && (maxclosemiddle(confidence)==0 || (abs(closemiddle-maxclosemiddle(confidence))<=7.0 && abs(farmiddle-minfarmiddle(confidence))<=10.0 && ...
                                  ...
                                  believe(confidence,1)=max(believe(confidence,1),peakrsquare(2,7+1,j));
                                  believe(confidence,2)=max(believe(confidence,2),peakrsquare(2,9+1,k));
                                  believe(confidence,3)=max(believe(confidence,3),peakrsquare(2,11+1,l));
                                  believe(confidence,4)=max(believe(confidence,4),peakrsquare(2,13+1,m));
