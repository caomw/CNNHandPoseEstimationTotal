...
locnet96 = Sequential()
locnet96.add(Convolution2D(8, 1, 5, 5,activation='relu'))
locnet96.add(MaxPooling2D(poolsize=(2,2)))
locnet96.add(Convolution2D(12, 8, 5, 5,activation='relu'))
locnet96.add(MaxPooling2D(poolsize=(2,2)))
locnet96.add(Convolution2D(16,8, 4, 4,activation='relu'))
locnet96.add(MaxPooling2D(poolsize=(2,2)))
locnet96.add(Flatten())
locnet96.add(Dense(1296, 50))
...
graph.add_node(Convolution2D(16,1,5,5,activation='relu'),name='conv196',input='input96')
...
graph.add_node(Convolution2D(16,1,3,3,activation='relu'),name='conv148',input='input48')
...
open('/home/zxy_wqf/keras-master/examples/cnn1/graphstructspatial.json','w').write(json_string)
minloss=1111.0
######Load Data
for epoch in range(0,500):
   for seq in range(1,7):         
      for kind in range(1,11):     
           ...
           if cnt % 10==0 and evalualoss<minloss:

                 minloss=evalualoss
                 graph.save_weights('/home/zxy_wqf/keras-master/examples/cnn1/graphmodelspatial.h5',overwrite=True)
